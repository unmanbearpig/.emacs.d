...
** Frame background mode
   Make sure that Emacs think the background is black, it gets confused some times.
   #+BEGIN_SRC emacs-lisp-
...
** todo-keywords
   ...
   (setq org-todo-keyword-faces '(("IN_PROGRESS" . "BLUE")))
   #+END_SRC
...
** company / yas integration
   ...
   Copy-paste from https://emacs.stackexchange.com/questions/7908/how-to-make-yasnippet-and-company-work-nicer
   #+BEGIN_SRC emacs-lisp
